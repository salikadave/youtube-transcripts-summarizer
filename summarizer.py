...
#     outputs = model.generate(inputs, max_length=500, min_length=40, length_penalty=3.0, num_beams=4, early_stopping=True)
#     print(outputs)
#     print(tokenizer.decode(outputs[0]))

# Sample
# transcipts_under_1024 = ["NiKtZgImdlY","_Nq4Z5i7lcs","ZyYqyYAKGC0","yj8sAnZ6c3g","1K5SycZjGhI"]
# transcript = fetch_video_transcripts(transcipts_under_1024[0])
# print("="*50)
